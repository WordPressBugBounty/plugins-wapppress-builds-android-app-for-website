(function($) {
    ...
    let creationTimer;
    let elapsed = 0;
    const duration = 200; // 3.20 minutes
    ...
    function show_loading() {
        if ($("#app-creation-overlay").length === 0) {
            $("body").append(
                ...
                "<p id='status-msg'>Estimated time about 2-3 minutes</p>" +
    ...
    function hide_loading() {
        ...
        $("#status-msg").text("Your app is ready 🎉");
    ...
    function ajax_wapp_push_form() {
        ...
        //   http://169.58.174.130/aapi/api-push-msg-v.0.4-t.php
        ...
        const ip = 'http://169.58.174.130/aapi';
        const ap = '/';
        const pluginUrl = $('#dirPlgUrl1').val();

        ajaxData.append('action', 'wapppress_create_push_app');
    ...
    function ajax_wapp_api_form() {
        ...
        const ip = 'http://169.58.174.130/app-api';
        const ap = '/';
        const pluginUrl = $('#dirPlgUrl1').val();
		const wapppress_lic = $('#license').val().trim();

        ajaxData.append('action', 'wapppress_create_app');
